...
* Favicon support: (1) find the ```static``` direcotry within ```themes/hugo-xterm```; (2) add your favicon in the ```static``` directory; and (3) add the following lines to the end of your ```themes/hugo-xterm/config.toml```
